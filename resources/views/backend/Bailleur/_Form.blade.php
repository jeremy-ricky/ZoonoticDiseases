          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                  ...
                  <label>Name *</label>
                    <input type="text" class="form-control" name="Nom" placeholder="Enter an name" value="{{ old('Nom') ?: $Bailleur->Nom }}" >
              ...
              <div class="col-md-6">
                  <div class="form-group">
                  <label>Phone *</label>
                    <input type="text" class="form-control" name="Telephone" placeholder="Enter your phone number" value="{{ old('Telephone') ?: $Bailleur->Telephone }}" >
              ...
              <div class="col-md-6">
                  <div class="form-group">
                  <label>E-mail *</label>
                    <input type="email" class="form-control" name="Email" placeholder="Enter your email" value="{{ old('Email') ?: $Bailleur->Email }}" >
